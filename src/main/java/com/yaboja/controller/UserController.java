...
//    	}
    	...
    	//path="C:\\Users\\MinYeop\\Desktop\\KH\\Workspace_Spring\\Yaboja\\src\\main\\webapp\\profile"; //서버 만들면 여기에!
	...
	public static JsonNode getAccessToken(String autorize_code){ 
	    ...
	    postParams.add(new BasicNameValuePair("redirect_uri", "http://3.210.71.242:8080/controller/kakaologin.do"));    // 리다이렉트 URI
